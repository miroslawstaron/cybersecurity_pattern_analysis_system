...
# This module uses SingBERTa to extract the embeddings from the code
# the model is trained on the code of WolfSSL and singletons
...
def extract_embeddings_singberta_one_file(strFile):
...
def extract_embeddings_singberta(strFolder, 
                                 strCodeFolder, 
                                 strReferenceFolder):
    ...
    dfEmbeddingFile.to_csv(os.path.join(strFolder, './embeddings_singberta.csv'), sep='$')

    return dfEmbeddingFile

def calculate_distances_singberta(strEmbeddingsFolder):
    ...
    strFile = os.path.join(strDir, 'embeddings_singberta.csv')
    ...
    dfDistances.to_csv(os.path.join(strEmbeddingsFolder, 'distances_singberta.csv'))
...
def analyze_singberta(strEmbeddingsFolder, csvFile):
    ...
    strDir = strEmbeddingsFolder
    strFile = os.path.join(strDir, 'distances_singberta.csv')
