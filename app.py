...
def predict():
    ...
    if model == 'codebert':
        ...
        if vulnerability == 'input_validation': 
            ...
            dfRefEmbeddings = pd.read_csv('database/embeddings_codebert_input_validation.csv', header=None, sep='$', index_col=0) 
            ...
            dfRefEmbeddings = pd.read_csv('database/embeddings_codebert_sql_injection.csv', header=None, sep='$', index_col=0)
        else:
        ...
        result, lstRefs = snippet_embeddings.tolist()
